...
* **High School Teacher**: Students should primarily contact your high school teacher for any assistance in this course.
 ...
 * None for High School Students
 * _(Effective Fall 2020 at K-State)_: CC 110 - Introduction to Computing (Prerequisite or Concurrent Enrollment)
...
_CC 210 objectives were developed using the taxonomy described in "Developing a Computer Science-specific Learning Taxonomy", Fuller, et al, 2007, on-line at [https://www.cs.kent.ac.uk/pubs/2007/2798/content.pdf](https://www.cs.kent.ac.uk/pubs/2007/2798/content.pdf)_

###  Course Structure

This course is intended to be taught 100% online, each module is self-paced, and each module must be completed to progress to the next one. Students are expected to make good progress; we have found students who fall behind often fail to successfully complete the class.  The expected schedule is one module every other week: we allow some flexibility in "due date."
...
Read this late work policy very carefully! If you are unsure how to interpret it, please contact the instructors. Not understanding the policy does not mean that it won’t apply to you!
...
Finally, all course work must be submitted on or before the last day of the semester in which the student is enrolled in the course in order for it to be graded.
